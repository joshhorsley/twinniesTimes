    ...
    return (
        ...
        <div className="p-3">
            ...
            <DataTable value={data.pointsHistory[0]}>
                ...
                <Column field="points_participation_awarded" header="Participation Awarded" ></Column>
                <Column field="points_handicap_awarded" header="Handicap Awarded" ></Column>
