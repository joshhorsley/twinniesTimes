      ...
      <Card>
        <div className="p-3">
          ...
          <DataTable value={data.changeHistory[0]}>
            <Column
              field="dateNextStartDisplay"
              header="Date"
              body={(data) => {
                return (
                  <Link to={`/races/${data.date_ymd_next}`}>
                    {data.dateNextStartDisplay}
                  </Link>
                );
              }}
            ></Column>
      ...
      <div className="contentScroll">
        <Container>
          ...
          <DataTable
            ...
            scrollable
            scrollHeight={`${
              windowDimensions.height - tableStart.start - 10
            }px`}
          ...
          >
            ...
            <Column
              ...
              body={(tableData) => {
                return (
                  <Link to={`/members/${tableData.id_member}`}>
                    {tableData.name_display}
                  </Link>
                );
              }}
              sortable
