...
export default function Header() {
  ...
  const {pathname} = useLocation() // previously imported from 'react-router-dom'
    ...
    return (
      <Navbar collapseOnSelect sticky="top" id="navbar" expand="lg" className="bg-body-tertiary">
...
{/* <ListGroup key={pathname}><ListGroup/> */}
         ...
         <Navbar.Brand onClick={() => navigate("/")} className='navbarBranding'>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav.Link eventKey="/committee" as={NavLink} to="/committee">Committee</Nav.Link>
